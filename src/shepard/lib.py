...
def deploy(account_number,role_to_assume_to_target_account,cloudformation_stack_name,path_to_deployment_folder,ecr_repo_to_push_to,dont_assume,mfa_token,serial_number):
    ...
    try:
        push_to_ecr(account_number,role_to_assume_to_target_account,ecr_repo_to_push_to,path_to_deployment_folder,dont_assume,mfa_token,serial_number)
    except Exception as error:
        traceback.print_tb(error.__traceback__)
    ...
    # run auto_configure
    auto_configure(cloudformation_stack_name, account_number, role_to_assume_to_target_account, dont_assume, mfa_token,
                   serial_number, path_to_deployment_folder = path_to_deployment_folder, called_by_deploy_function = True)
    return
