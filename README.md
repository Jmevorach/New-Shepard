...
The Hello World Example above installs Shepard, deploys the testing-setup hosted at https://github.com/Jmevorach/Shepard-Setups and then runs a job through that setup. The sample job we run has one environment variable set with the name "an_example_variable_name" and the value "an_example_variable_value".  
...
##### ** General Stack Parameters**
  * <ins>stack_name</ins> - Name of the cloudformation stack that will be used to create your flock.
...
##### **Batch Parameters**
  ...
  * <ins>RetryAttempts</ins> - The number of times jobs run on sheep in your flock will attempt to retry in the event they fail. Defaults to 1. 
